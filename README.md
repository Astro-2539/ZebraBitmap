...
## 字体覆盖范围
本字体目前计划覆盖 GB/T 2312 规定的所有字符（包括 6763 个汉字）、《通用规范汉字表》中的所有汉字（共8105个）及部分上述标准之外的汉字。目前实际覆盖 1258 个汉字。
汉字的详细覆盖范围如下：（计数软件见[这里](https://github.com/NightFurySL2001/CJK-character-count)）
![收字范围20240121](https://github.com/Astro-2539/ZebraBitmap/assets/151385587/cb63b91a-2a8a-45f4-8894-8a37e4964fda)
